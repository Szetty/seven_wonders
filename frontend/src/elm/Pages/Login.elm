            ...
            [ div [ class "card-body row justify-content-center" ]
                [ div [ onEnter Submit ]
                    [ div [ class "md-form md-2" ]
                        [ input [ class "form-control", placeholder "Access Token", value model.form.accessToken, onInput GotAccessToken, autocomplete "off" ] []
                        ]
                    , div [ class "md-form mt-2" ]
                            [ input [ class "form-control", placeholder "Name", value model.form.name, onInput GotName, autocomplete "username" ] []
                        ]
